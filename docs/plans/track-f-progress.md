...
|---|---|---|---|---|---|---|
| **A** | editor_mode + hard_rules + 审稿 API | `feat/track-f/week1-editor-mode` | 🔵 pending | – | – | – |
| **B** | event_store + Event/Session 表 + 迁移 | `feat/track-f/week2-event-store` | � done | 待开 PR | 2026-05-12 | Cascade 接手完成。22/22 测试 + alembic 三连过 |
