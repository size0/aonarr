...
class Settings(BaseModel):
    ...
    sse_token_ttl_seconds: int = int(os.getenv("SSE_TOKEN_TTL_SECONDS", "60"))
    ...
    database_url: str = os.getenv("DATABASE_URL", "postgresql://aonarr:change-me@localhost:5432/aonarr")
